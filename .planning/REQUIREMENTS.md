...
- [ ] **IMG-03**: User sees smooth blurhash placeholder while images load
- [ ] **IMG-04**: Recipe images are optimized (WebP, <100KB) and bundled via build pipeline with static registry
